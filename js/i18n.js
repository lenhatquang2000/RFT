...
const I18N = {
  vi: {
    ...
    // mobile view
    mobileRanking: 'Xếp Hạng Dây Chuyền',
    mobileTarget: 'Mục tiêu',
    mobileDetails: 'Chi Tiết Hiệu Suất',
    mobileTopModels: 'Top Models Performance',
    mobileBestModels: 'Best Models',
    mobileWorstModels: 'Worst Models',
    mobileDefects: 'lỗi',
    mobileNoData: 'Dữ liệu dashboard sẽ hiển thị ở đây',
    mobileNoDataSub: 'Vui lòng tải dữ liệu ở tab Dashboard',
    mobileKpiInspected: 'Tổng SL Kiểm Tra',
    mobileKpiRFT: 'RFT Trung Bình',
    mobileKpiDefects: 'Tổng Lỗi',
    mobileKpiSub1: 'lô sản xuất',
    mobileKpiSub2: 'Mục tiêu: ≥95%',
    mobileKpiSub3: 'Tỷ lệ:',
    mobileUpdated: 'Cập nhật:',
  },
  zh: {
    ...
    mobileTarget: '目标',
    mobileDetails: '详细绩效',
    mobileTopModels: '型号绩效对比',
    mobileBestModels: '最佳型号',
    mobileWorstModels: '最差型号',
    mobileDefects: '个缺陷',
    mobileNoData: '仪表板数据将显示在这里',
    mobileNoDataSub: '请在仪表板标签页加载数据',
    mobileKpiInspected: '总检验数量',
    mobileKpiRFT: '平均合格率',
    mobileKpiDefects: '总缺陷数',
    mobileKpiSub1: '批次',
    mobileKpiSub2: '目标: ≥95%',
    mobileKpiSub3: '比率:',
    mobileUpdated: '更新时间:',
  ...
  en: {
    ...
    // mobile view
    mobileRanking: 'Line Ranking',
    mobileTarget: 'Target',
    mobileDetails: 'Performance Details',
    mobileTopModels: 'Top Models Performance',
    mobileBestModels: 'Best Models',
    mobileWorstModels: 'Worst Models',
    mobileDefects: 'defects',
    mobileNoData: 'Dashboard data will be displayed here',
    mobileNoDataSub: 'Please load data from Dashboard tab',
    mobileKpiInspected: 'Total Inspected',
    mobileKpiRFT: 'Average RFT',
    mobileKpiDefects: 'Total Defects',
    mobileKpiSub1: 'production lots',
    mobileKpiSub2: 'Target: ≥95%',
    mobileKpiSub3: 'Rate:',
